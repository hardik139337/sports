        ...
        <div>
            <div className="card row">
                <div className="col-md-4">
                    <img src="https://image.crictracker.com/wp-content/uploads/2020/09/AB-de-Villiers-1.jpg" alt="" />

                </div>
                <div className="col-md-8">
                    <h5>IPL 2021: Top 5 batsmen with highest individual scores in IPL history</h5>
                    <p>   In the T20 format, if a player scores a century for the team, then most of the time it becomes quite easy to win the match as well. The same is applicable in glo...</p>
